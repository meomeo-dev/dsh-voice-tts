...
const en = {
  ...
  'menu.toggle.sub.off': 'New messages are silent · click to turn on',
  'menu.toggle.sub.on': 'New messages are auto-spoken · click to turn off',
...
const zh: Record<VoiceTtsSlotKey, string> = {
  ...
  'menu.toggle.off': 'Turn on voice tts',
  'menu.toggle.on': 'Turn off voice tts',
  'menu.toggle.sub.off': '新消息静默 · 点击开启',
  'menu.toggle.sub.on': '新消息自动播报 · 点击关闭',
  'menu.stop': 'Stop Current Host Play',
